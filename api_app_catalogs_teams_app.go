...
func (a *AppCatalogsTeamsAppApiService) AppCatalogsGetTeamsApps(ctx _context.Context, teamsAppId string, localVarOptionals *AppCatalogsGetTeamsAppsOpts) (MicrosoftGraphTeamsApp, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"teamsApp-id"+"}", _neturl.QueryEscape(parameterToString(teamsAppId, "")), -1)
...
*/
func (a *AppCatalogsTeamsAppApiService) AppCatalogsTeamsAppsGetAppDefinitions(ctx _context.Context, teamsAppId string, teamsAppDefinitionId string, localVarOptionals *AppCatalogsTeamsAppsGetAppDefinitionsOpts) (MicrosoftGraphTeamsAppDefinition, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarPath = strings.Replace(localVarPath, "{"+"teamsAppDefinition-id"+"}", _neturl.QueryEscape(parameterToString(teamsAppDefinitionId, "")), -1)
...
*/
func (a *AppCatalogsTeamsAppApiService) AppCatalogsTeamsAppsListAppDefinitions(ctx _context.Context, teamsAppId string, localVarOptionals *AppCatalogsTeamsAppsListAppDefinitionsOpts) (CollectionOfTeamsAppDefinition, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
