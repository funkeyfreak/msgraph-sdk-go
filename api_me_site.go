...
// MeGetFollowedSitesOpts Optional parameters for the method 'MeGetFollowedSites'
type MeGetFollowedSitesOpts struct {
	Select_ optional.Interface
	Expand  optional.Interface
}

/*
MeGetFollowedSites Get followedSites from me
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId key: site-id of site
 * @param optional nil or *MeGetFollowedSitesOpts - Optional Parameters:
...
*/
func (a *MeSiteApiService) MeGetFollowedSites(ctx _context.Context, siteId string, localVarOptionals *MeGetFollowedSitesOpts) (MicrosoftGraphSite, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/me/followedSites/{site-id}"
...
// MeListFollowedSitesOpts Optional parameters for the method 'MeListFollowedSites'
type MeListFollowedSitesOpts struct {
	Top     optional.Int32
	Skip    optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MeListFollowedSitesOpts - Optional Parameters:
...
*/
func (a *MeSiteApiService) MeListFollowedSites(ctx _context.Context, localVarOptionals *MeListFollowedSitesOpts) (CollectionOfSite, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/me/followedSites"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
