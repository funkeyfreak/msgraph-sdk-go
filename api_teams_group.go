...
// TeamsGetGroupOpts Optional parameters for the method 'TeamsGetGroup'
type TeamsGetGroupOpts struct {
 ...
 * @param optional nil or *TeamsGetGroupOpts - Optional Parameters:
...
*/
func (a *TeamsGroupApiService) TeamsGetGroup(ctx _context.Context, teamId string, localVarOptionals *TeamsGetGroupOpts) (MicrosoftGraphGroup, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/teams/{team-id}/group"
