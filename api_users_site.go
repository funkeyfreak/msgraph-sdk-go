...
// UsersGetFollowedSitesOpts Optional parameters for the method 'UsersGetFollowedSites'
type UsersGetFollowedSitesOpts struct {
	Select_ optional.Interface
	Expand  optional.Interface
}

/*
UsersGetFollowedSites Get followedSites from users
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId key: user-id of user
 * @param siteId key: site-id of site
 * @param optional nil or *UsersGetFollowedSitesOpts - Optional Parameters:
...
*/
func (a *UsersSiteApiService) UsersGetFollowedSites(ctx _context.Context, userId string, siteId string, localVarOptionals *UsersGetFollowedSitesOpts) (MicrosoftGraphSite, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/users/{user-id}/followedSites/{site-id}"
...
// UsersListFollowedSitesOpts Optional parameters for the method 'UsersListFollowedSites'
type UsersListFollowedSitesOpts struct {
	Top     optional.Int32
	Skip    optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId key: user-id of user
 * @param optional nil or *UsersListFollowedSitesOpts - Optional Parameters:
...
*/
func (a *UsersSiteApiService) UsersListFollowedSites(ctx _context.Context, userId string, localVarOptionals *UsersListFollowedSitesOpts) (CollectionOfSite, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users/{user-id}/followedSites"
	localVarPath = strings.Replace(localVarPath, "{"+"user-id"+"}", _neturl.QueryEscape(parameterToString(userId, "")), -1)
