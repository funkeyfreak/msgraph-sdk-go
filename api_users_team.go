 ...
 * @param microsoftGraphTeam New navigation property
@return MicrosoftGraphTeam
*/
func (a *UsersTeamApiService) UsersCreateJoinedTeams(ctx _context.Context, userId string, microsoftGraphTeam MicrosoftGraphTeam) (MicrosoftGraphTeam, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphTeam
*/
func (a *UsersTeamApiService) UsersGetJoinedTeams(ctx _context.Context, userId string, teamId string, localVarOptionals *UsersGetJoinedTeamsOpts) (MicrosoftGraphTeam, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users/{user-id}/joinedTeams/{team-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"user-id"+"}", _neturl.QueryEscape(parameterToString(userId, "")), -1)
...
*/
func (a *UsersTeamApiService) UsersListJoinedTeams(ctx _context.Context, userId string, localVarOptionals *UsersListJoinedTeamsOpts) (CollectionOfTeam, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *UsersTeamApiService) UsersUpdateJoinedTeams(ctx _context.Context, userId string, teamId string, microsoftGraphTeam MicrosoftGraphTeam) (*_nethttp.Response, error) {
	var (
